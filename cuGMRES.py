...
#     print(string_fun_so)
    string_fun_so = string_fun_so.split("\n")[0] #choose first serch result    
#     print(so_CDLL._Z20Fast_GMRES_with_CUDAPK6float2PKbPS_PPfPjiPP13cublasContextfbjPbjP17cusolverDnContextP8timespecj)
#     print(string_fun_so)
...
path_to_so = '/media/linux/4db3d51d-3503-451d-aff7-07e3ce95927e/Module/TestLib.so'
